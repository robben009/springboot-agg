...
public class OrderHandler2 extends OrderAbstractHandler<OrderStatusEnum, OrderEventEnum, OrderContext> {

    @Override
    public void execute(OrderStatusEnum from, OrderStatusEnum to, OrderEventEnum event, OrderContext context) {
        log.info("事件 MyEventEnum.EVENT2 触发了");
    ...
    public void afterPropertiesSet() {
        OrderAbstractHandlerFactory.registerHandler(OrderEventEnum.EVENT2, this);
    }
